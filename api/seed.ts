  ...
  try {
    ...
    const sampleCompanies = await db.insert(companies).values([
      ...
      },
      {
        ...
        description: "Fast-growing startup focused on innovative mobile applications",
    ...
    const sampleJobs = await db.insert(jobs).values([
      {
        ...
        description: "Join our team to build scalable web applications using React, Node.js, and PostgreSQL. You'll work on exciting projects with cutting-edge technology and collaborate with a talented team of engineers.",
      ...
      },
      {
        ...
        description: "Seeking a data scientist to help drive business decisions through advanced analytics and machine learning. Work with large datasets and build predictive models.",
        ...
        responsibilities: "• Analyze complex datasets to extract insights\n• Build and deploy machine learning models\n• Create data visualizations and reports\n• Collaborate with business stakeholders\n• Present findings to executive team",
      ...
      },
      {
        ...
        description: "Looking for a DevOps engineer to help automate our infrastructure and improve deployment processes. Experience with containerization and CI/CD pipelines required.",
      ...
      },
      {
        ...
        description: "Join our mobile app development team to create beautiful and intuitive user interfaces. We're looking for someone passionate about user experience and modern frontend technologies.",
        ...
        salaryMin: 80000,
        salaryMax: 120000,
        skills: ["React Native", "JavaScript", "Mobile Development", "UI/UX", "Redux"]
      },
      {
        title: "Product Manager",
        description: "Seeking an experienced product manager to lead our enterprise software initiatives. You'll work closely with engineering, design, and sales teams to deliver world-class products.",
      ...
      },
      {
        ...
        description: "Creative UX/UI designer needed to help shape the future of our products. You'll design user-centered experiences that delight our customers and drive business results.",
